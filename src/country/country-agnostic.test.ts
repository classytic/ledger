...
import { closeFiscalPeriod } from '../reports/fiscal-close.js';
import { createFiscalPeriodSchema } from '../schemas/fiscal-period.schema.js';
import { isVirtualTaxAccount, buildAccountTypeMap } from '../utils/account-helpers.js';
...
const mockUsPack = defineCountryPack({
  ...
  accountTypes: [
    ...
    { code: 'Fixed Assets', name: 'Fixed Assets', category: 'Balance Sheet-Asset', description: '', parentCode: null, isGroup: true, isTotal: false, cashFlowCategory: null },
    ...
    { code: 'Stockholders Equity', name: 'Stockholders\' Equity', category: 'Balance Sheet-Equity', description: '', parentCode: null, isGroup: true, isTotal: false, cashFlowCategory: null },
    ...
    { code: '2100', name: 'Sales Tax Payable', category: 'Balance Sheet-Liability', description: '', parentCode: 'Current Liabilities', isTotal: true, isVirtualTotal: true, cashFlowCategory: null, totalAccountTypes: [{ account: '2101', operation: '+' }, { account: '2102', operation: '+' }] },
    { code: '2101', name: 'State Sales Tax', category: 'Balance Sheet-Liability', description: '', parentCode: '2100', isTotal: false, cashFlowCategory: null },
    { code: '2102', name: 'City Sales Tax', category: 'Balance Sheet-Liability', description: '', parentCode: '2100', isTotal: false, cashFlowCategory: null },

    // Posting accounts
    { code: '1000', name: 'Cash and Cash Equivalents', category: 'Balance Sheet-Asset', description: '', parentCode: 'Current Assets', isTotal: false, cashFlowCategory: 'Operating' },
    { code: '1200', name: 'Accounts Receivable', category: 'Balance Sheet-Asset', description: '', parentCode: 'Current Assets', isTotal: false, cashFlowCategory: 'Operating' },
    { code: '1500', name: 'Property, Plant & Equipment', category: 'Balance Sheet-Asset', description: '', parentCode: 'Fixed Assets', isTotal: false, cashFlowCategory: 'Investing' },
    ...
    { code: '3000', name: 'Common Stock', category: 'Balance Sheet-Equity', description: '', parentCode: 'Stockholders Equity', isTotal: false, cashFlowCategory: null },
    { code: '3200', name: 'Retained Earnings', category: 'Balance Sheet-Equity', description: '', parentCode: 'Stockholders Equity', isTotal: false, cashFlowCategory: null },
    { code: '3210', name: 'Current Year Earnings', category: 'Balance Sheet-Equity', description: '', parentCode: 'Stockholders Equity', isTotal: false, cashFlowCategory: null },
    ...
    { code: '5000', name: 'Cost of Materials', category: 'Income Statement-Expense', description: '', parentCode: 'Cost of Goods Sold', isTotal: false, cashFlowCategory: null },
    { code: '5100', name: 'Direct Labor', category: 'Income Statement-Expense', description: '', parentCode: 'Cost of Goods Sold', isTotal: false, cashFlowCategory: null },
    { code: '6000', name: 'Rent Expense', category: 'Income Statement-Expense', description: '', parentCode: 'Operating Expenses', isTotal: false, cashFlowCategory: null },
    { code: '6100', name: 'Payroll Expense', category: 'Income Statement-Expense', description: '', parentCode: 'Operating Expenses', isTotal: false, cashFlowCategory: null },
...
describe('US Country Pack — Basics', () => {
  ...
  it('every parentCode resolves', () => {
    const parentCodes = [...new Set(
      mockUsPack.accountTypes.map(a => a.parentCode).filter(Boolean),
    )] as string[];
...
describe('isVirtualTaxAccount — structural check', () => {
  ...
  it('account with no parentCode is not virtual tax', () => {
    const topLevel: AccountType = { code: '9999', name: 'Top', category: 'Balance Sheet-Asset' as any, description: '', parentCode: null };
